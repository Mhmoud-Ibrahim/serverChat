...
//     try {
//       // التأكد أن المستخدم عضو في هذه المجموعة للأمان
...
//       // جلب تاريخ رسائل المجموعة (تحتاج موديل رسائل يدعم roomId)
...
//     try {
//       // حفظ الرسالة في الداتابيز (أضف حقل room في MessagesModel)
//       const savedMsg = await MessagesModel.create({
//         text: msg || "",
//         imageUrl: imageUrl || "",
//         sender: userId,
//         room: roomId, // ربطها بالغرفة بدلاً من مستقبل واحد
//         seen: false
//       });
//        const responseData = {
//         _id: savedMsg._id,
...
//         senderId: userId,
//         senderName: socket.data.userName, // بفضل socketAuth
//         roomId: roomId,
//         createdAt: (savedMsg as any).createdAt
//       };

//       // إرسال الرسالة لكل أعضاء الغرفة المتصلين حالياً
